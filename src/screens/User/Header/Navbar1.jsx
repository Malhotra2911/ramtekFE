...
import croppedlogo from '../../../assets/donation-right.png';
    ...
    <>
        ...
        <NavLink to="/" onClick={() => setisMobile(false)}>
          ...
          >
            <img
              ...
              alt="ss"
            />
            <p>श्री दिगम्बर जैन अतिशय क्षेत्र रामटेक </p>
          </div>
        </NavLink>
        ...
        <div className={isMobile ? 'main_div_header10' : 'main_div_header10'}>
          ...
          {/* <div class="dropdown">
            <button class="dropbtn">
              चंद्रागिरी <KeyboardArrowDownIcon />
            </button>
          ...
          {/* <div class="dropdown">
            ...
            <div class="dropdown-content">
              ...
              <NavLink to="/">चंद्रागिरी गैलरी</NavLink>
            </div>
          </div> */}
          {/* <NavLink className="link_direct" to="/">
            आचार्य श्री
          ...
          {/* <div class="dropdown">
            ...
            <div class="dropdown-content">
              ...
              <NavLink to="/"> चंद्रागिरी जिनालय</NavLink>
      ...
      <nav className={isMobile ? 'mobile_navber' : 'mobile_navber_hide'}>
        <div className="mobile_navber_hide_INear_main">
          ...
          >
            <p>चंद्रागिरी</p> {showmenu1 ? <RemoveIcon /> : <AddIcon />}
          </div> */}
